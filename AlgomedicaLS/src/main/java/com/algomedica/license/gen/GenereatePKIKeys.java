...
public class GenereatePKIKeys {
	...
	private static void generateKeys(String keyAlgorithm, int numBits) {
		...
		try {
			...
			// save public key
			saveToFile("/home/ubuntu/public_key.der", publicKeySpec.getEncoded());
			// save private key
			saveToFile("/home/ubuntu/private_key.der", privateKeySpec.getEncoded());
